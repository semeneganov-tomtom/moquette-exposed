...
public final class MQTTConnection {
    ...
    public PostOffice.RouteResult processConnect(MqttConnectMessage msg) {
    ...
    public PostOffice.RouteResult processDisconnect(MqttMessage msg) {
        final String clientID = NettyUtils.clientID(channel);
    ...
    public PostOffice.RouteResult processSubscribe(MqttSubscribeMessage msg) {
        final String clientID = NettyUtils.clientID(channel);
        if (!connected) {
    ...
    public PostOffice.RouteResult processPublish(MqttPublishMessage msg) {
